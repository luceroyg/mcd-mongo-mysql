...
```
db.actor.aggregate([{$lookup:{from: "film_actor",localField: "_id",foreignField: "actor_id",as: "filmActor"}},{$project: {filmActorSize: { name:"fist_name",lastname:"last_name",$size: "$filmActor" }}}])
```
