...
```
db.actor.aggregate([{$lookup:{from: "film_actor",localField: "_id",foreignField: "actor_id",as: "filmActor"}},{$project: {filmActorSize: { name:"$actor.first_name",lastname:"$actor.last_name",$size: "$filmActor" }}}])
```
