...
```
db.actor.aggregate([{$lookup:{from: "film_actor",localField: "_id",foreignField: "actor_id",as: "filmActor"}},{$project: { name:"$actor.first_name",lastname:"$actor.last_name",filmActorSize:{$size: "$filmActor" }}},{$match: {filmActorSize: { $gt: 35 }}}])
```
